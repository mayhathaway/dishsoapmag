      ...
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
              ...
              <Link to="/9-15-26">
<h2 className={archiveStyles.piecelink}>Green Music</h2>
            </Link>
            <p>keith woodruff</p>
      ...
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
              ...
              <Link to="/8-25-26">
<h2 className={archiveStyles.piecelink}>Your Dead Father on the Train from Babylon</h2>
            </Link>
            <p>joanna theiss</p>

<Link to="/8-18-26">
<h2 className={archiveStyles.piecelink}>simulation sickness</h2>
            </Link>
            <p>anisha arvind</p>

                         <Link to="/8-11-26">
<h2 className={archiveStyles.piecelink}>This is Awkward</h2>
            </Link>
            <p>jason fraley</p>

                          <Link to="/8-4-26">
<h2 className={archiveStyles.piecelink}>Tigers</h2>
            </Link>
            <p>daniel ditty</p>
      ...
      <h1 className={issueStyles.heading}>july 2026</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
...
<h2 className={archiveStyles.piecelink}>Mom's Bigfoot</h2>
      ...
      <h1 className={issueStyles.heading}>june 2026</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
...
<h2 className={archiveStyles.piecelink}>My cat sits on me, incubating Sad-Away</h2>
            ...
            <p>thanh bui</p>
               ...
               <Link to="/6-9-26">
<h2 className={archiveStyles.piecelink}>A brief obsession, and how to form one.</h2>
            </Link>
            <p>nicole davis</p>

              <Link to="/6-2-26">
<h2 className={archiveStyles.piecelink}>Ars Poetica as Transcription</h2>
            </Link>
            <p>claire salvato</p>
              </div>
            </div>
...
<h1 className={issueStyles.heading}>may 2026</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>

              <Link to="/5-26-26">
<h2 className={archiveStyles.piecelink}>A Beginning with No End</h2>
            </Link>
            <p>joel tomfohr</p>
...
<h2 className={archiveStyles.piecelink}>Paul From the Future</h2>
            ...
            <p>sarp sozdinler</p>
              ...
              <Link to="/5-12-26">
<h2 className={archiveStyles.piecelink}>blue body</h2>
            </Link>
            <p>k.m. hanslik</p>

              <Link to="/5-5-26">
<h2 className={archiveStyles.piecelink}>Limerence Dingus</h2>
            </Link>
            <p>gretchen uhrinek</p>
              </div>
            </div>
          </div>
          <br></br>
...
<h1 className={issueStyles.heading}>april 2026</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
...
<h2 className={archiveStyles.piecelink}>The Girlfriends Of The Propeller Plane Disappearance Victims</h2>
            ...
            <p>dallon robinson</p>
               ...
               <Link to="/4-14-26">
<h2 className={archiveStyles.piecelink}>Juno</h2>
            </Link>
            <p>trinity richardson</p>
...
<h1 className={issueStyles.heading}>march 2026</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>

               <Link to="/3-31-26">
<h2 className={archiveStyles.piecelink}>Slow it Down</h2>
            </Link>
            <p>jack b. bedell</p>

              <Link to="/3-24-26">
<h2 className={archiveStyles.piecelink}>My Father Bought a Generator in 1997 and It Is Still Running</h2>
            </Link>
            <p>oluwanifemi bakare</p>
...
<Link to="/2-24-26">
<h2 className={archiveStyles.piecelink}>Clearance Aisle</h2>
            </Link>
            <p>nicholas grider</p>

 <Link to="/2-17-26">
<h2 className={archiveStyles.piecelink}>A Nocturne for the Flowers</h2>
            </Link>
            <p>m. j. young</p>
      ...
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
              ...
              <Link to="/1-27-26">
<h2 className={archiveStyles.piecelink}>What Work</h2>
            </Link>
            <p>stephanie rick</p>
...
<h2 className={archiveStyles.piecelink}>The Great Metro Detroit Flood</h2>
            ...
            <p>shea socrates</p>
              ...
              <Link to="/1-13-26">
<h2 className={archiveStyles.piecelink}>Cargo</h2>
            </Link>
            <p>daniel kim</p>
...
<h1 className={issueStyles.heading}>december 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>

              <Link to="/12-30-25">
<h2 className={archiveStyles.piecelink}>did you know kramer’s name was originally kessler?</h2>
            </Link>
            <p>ben starr</p>

<Link to="/12-23-25">
<h2 className={archiveStyles.piecelink}>Forty-Seven Angles</h2>
            </Link>
            <p>raymond brunell</p>
...
<h1 className={issueStyles.heading}>november 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
...
<Link to="/11-25-25">
            ...
            <p>k.m. hanslik</p>
              ...
              <Link to="/11-18-25">
            <h2 className={archiveStyles.piecelink}>In Fields and Bookshelves and Pockets</h2>
            </Link>
            <p>h.m. wilson</p>

                 <Link to="/11-11-25">
            <h2 className={archiveStyles.piecelink}>Lobiani</h2>
            </Link>
            <p>bradley k. meyer</p>

              <Link to="/11-4-25">
            <h2 className={archiveStyles.piecelink}>Cadillacs on the Moon</h2>
            </Link>
            <p>travis flatt</p>
...
<h1 className={issueStyles.heading}>october 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>

              <Link to="/10-28-25">
            <h2 className={archiveStyles.piecelink}>Imagine a Future Where Nobody Has to Hide Their Tenderness</h2>
            </Link>
            <p>justin karcher</p>
   ...
   <Link to="/10-21-25">
            ...
            <p>michelle li</p>
                ...
                <Link to="/10-14-25">
            <h2 className={archiveStyles.piecelink}>None of Us Are Elected</h2>
            </Link>
            <p>robert mcdonald</p>

              <Link to="/10-7-25">
            <h2 className={archiveStyles.piecelink}>Horoscope</h2>
            </Link>
            <p>michael favala goldman</p>
...
<h1 className={issueStyles.heading}>september 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>

              <Link to="/9-30-25/">
            <h2 className={archiveStyles.piecelink}>Miriam</h2>
            </Link>
            <p>natalie korman</p>

<Link to="/9-23-25/lizard/">
            <h2 className={archiveStyles.piecelink}>The Lizard That Lives in My Chest</h2>
            </Link>
            <p>sharon aruparayil</p>

              <Link to="/9-16-25/chuck/">
            <h2 className={archiveStyles.piecelink}>Chuck & Rose</h2>
            </Link>
            <p>keith j. powell</p>
 ...
 <Link to="/9-2-25/town/">
            <h2 className={archiveStyles.piecelink}>The Other Side of Town</h2>
            </Link>
            <p>christy hartman</p>
...
<h1 className={issueStyles.heading}>august 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>

 <Link to="/8-26-25/smoke/">
            <h2 className={archiveStyles.piecelink}>Smoke</h2>
            </Link>
            <p>ben fowlkes</p>
...
<h1 className={issueStyles.heading}>july 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
 ...
 <Link to="/7-22-25/pastoral/">
            <h2 className={archiveStyles.piecelink}>pastoral on cymbalta</h2>
            </Link>
            <p>nat raum</p>
...
<h1 className={issueStyles.heading}>june 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
...
<Link to="/6-10-25/bear/">
            <h2 className={archiveStyles.piecelink}>Would You Bring Me Back to Life if I Got Bitten by a Dead Blue-eyed Bear?</h2>
            </Link>
            <p>bob king</p>

<Link to="/6-3-25/rodeo/">
            <h2 className={archiveStyles.piecelink}>Don’t Worry, This is My Second Rodeo; Let Me Tell You How Rodeos Work</h2>
            </Link>
            <p>dan weaver</p>
      ...
      <h1 className={issueStyles.heading}>may 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>
...
<Link to="/5-27-25/moonboy/">
      ...
      <h1 className={issueStyles.heading}>april 2025</h1>
      <div className={layoutStyles.mission}>
          <div className={issueStyles.parent}>
            <div className={issueStyles.bottomMargin}>

            <Link to="/4-29-25/summer/">
            <h2 className={archiveStyles.piecelink}>Forever Summer</h2>
            </Link>
            <p>parker logan</p>
            ...
            <Link to="/4-15-25/iShoVel/">
            <h2 className={archiveStyles.piecelink}>Dude, I went to Mario’s last night and there was this journalist guy interviewing iShoVel</h2>
            </Link>
            <p>jan hassmann</p>
